...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case ProxyIP: {
            ...
            QStringList strlIpPort = SplitSkipEmptyParts(settings.value("addrProxy").toString(), ":");
        ...
        case ProxyIPTor: {
            // contains IP at index 0 and port at index 1
            QStringList strlIpPort = SplitSkipEmptyParts(settings.value("addrSeparateProxyTor").toString(), ":");
            return strlIpPort.at(0);
        }
        case ProxyPortTor: {
            // contains IP at index 0 and port at index 1
